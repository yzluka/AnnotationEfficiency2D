...
class Brats_Dataset(Dataset):
    """class labels: background-0, necrotic and non-enhancing tumor core-1,
       peritumoral edema-2, GD-enhancing tumor-3 (4 in the original data, turned to 3
       for the purpose of training)."""

    def __init__(self,data_root, split='trainval', msk_styl ='perfe', modality='f_', data_transform=None, 
                 target_transform=None, crop=False, crop_size=320, flip=True,rot = True):
        """
        Args:
        ...
        if 'bbox_msk' == msk_styl:
            self.styl = 'bbox_' + modality[0]
    ...
    def __getitem__(self, idx):
        ...
        img_name = f'{self.data_root}/img/{self.modality}{self.filenames[idx]}' 
